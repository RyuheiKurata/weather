...
function makePage(data) {
  ...
  setData('day0', dateFormat(data.daily.time[
    0
  ]));
  setData('day1', dateFormat(data.daily.time[
    0
  ]));
  ...
  setData('temperature_2m_max0', data.daily.temperature_2m_max[
    0
  ] + '°C');
  setData('temperature_2m_max1', data.daily.temperature_2m_max[
    1
  ] + '°C');

  setData('temperature_2m_min0', data.daily.temperature_2m_min[
    0
  ] + '°C');
  setData('temperature_2m_min1', data.daily.temperature_2m_min[
    1
  ] + '°C');

  setData('precipitation_sum0', data.daily.precipitation_sum[
    0
  ] + 'mm');
  setData('precipitation_sum1', data.daily.precipitation_sum[
    1
  ] + 'mm');

  if ( data.daily.precipitation_sum[0] > 0 ) {
    document.getElementById('body').style.backgroundImage
     = 'linear-gradient(#ccf 5%, #fff 70%)';
  } else {
    document.getElementById('body').style.backgroundImage
     = 'linear-gradient(#fec 5%, #fff 70%)';
  }
